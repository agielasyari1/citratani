var userTable;
    ...
    $(document).ready(function() {
        ...
        userTable = $('#example').DataTable({ 
            ...
            "ajax": {
                "url": site_url+"laporan_beli/view_pb",
                "type": "POST",
                data:{ajaxreq:true}
            },
            "columnDefs": [
        ...
        $("#okBtn").on('click', function (){
            ...
            var res = range.split(" - ");
            if(jenis != "" && res != ""){
                userTable.ajax.url( site_url + "laporan_beli/view_pb/" + jenis + "/" + res[0] + "/" + res[1]).load();
                total_table(jenis, res[0], res[1]);
            }else{
    ...
    function total_table(jenis, awal, akhir){
        ...
        $.ajax({
            url : site_url+"laporan_beli/total_table_beli/" + jenis + "/" + awal + "/" +akhir,
            type: "POST",
