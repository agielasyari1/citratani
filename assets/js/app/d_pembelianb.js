    ...
    $(document).ready(function() {
       ...
       $("#batalBtn").click(function (){
            $.ajax({
                url : site_url+'d_pembelianb/batal/'+$("#no_pembelian").val(),
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
                   if(data.status){
                       window.location = site_url+"b_pembelian";
                   }
                }
            });  
       });
       ...
       $("#harga_satuan").keyup(function (){
        ...
        userTable = $('#example').DataTable({ 
            ...
            "ajax": {
                "url": site_url+"d_pembelianb/view/"+$("#no_pembelian").val(),
                "type": "POST",
                data:{ajaxreq:true}
            },
            "columnDefs": [
        ...
        $('#qty').on('keyup', function(){
         ...
         $('#prosessBtn').on('click', function(){
             ...
             $.ajax({
                url : site_url+"b_pembelian/detail/"+$("#pno_pembelian").val(),
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
        ...
        $('#yesBtn').on('click', function(){
            $.ajax({
                url : site_url+"d_pembelianb/delete/"+deletedId ,
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
    ...
    function addUser(fv){
         ...
         var url;
         if(action == "Add"){
             url = site_url+"d_pembelianb/add";
         }else{
             url = site_url+"d_pembelianb/update";
             action = "Add";
         }
    ...
    function addUser2(fv){
         ...
         var url = site_url+"b_pembelian/update";
    ...
    function change(id){
        ...
        $('#username2').val(id);
        $.ajax({
                url : site_url+"d_pembelianb/detail/"+id ,
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
    ...
    function print_kw(id){
     ...
     function total_jual(id){
         $.ajax({
                url : site_url+"b_pembelian/get_total_jual/"+id,
                type: "GET",
                dataType: "JSON",
    ...
    function count_sisa_kembali(){
     ...
     function generate_auto(){
        ...
        $( "#id_barang" ).autocomplete();
              ...
              $( "#id_barang" ).autocomplete({
                    source: site_url+"barang/daftar_barangB2",
                    minLength: 2,
