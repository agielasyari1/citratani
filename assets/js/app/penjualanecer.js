    ...
    $(document).ready(function() {
        ...
        $("#addBtn").click(function (){
           window.location = site_url+"d_penjualanecer/penjualan_baru";
        });
        ...
        userTable = $('#example').DataTable({ 
            ...
            "ajax": {
                "url": site_url+"penjualanecer/view",
                "type": "POST",
                data:{ajaxreq:true}
            },
            "columnDefs": [
        ...
        $('#yesBtn').on('click', function(){
            $.ajax({
                url : site_url+"penjualanecer/delete/"+deletedId ,
                type: "GET",
                dataType: "JSON",
    ...
    function detail(id){
        window.location = site_url+"d_penjualanecer/view_detail/"+id;
    }
