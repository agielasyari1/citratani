    ...
    $(document).ready(function() {
        ...
        $("#addBtn").click(function (){
           window.location = site_url+"d_pembelianb/pembelian_baru";
        });
        ...
        $('#yesBtn').on('click', function(){
            $.ajax({
                url : site_url+"b_pembelian/delete/"+deletedId ,
                type: "GET",
                dataType: "JSON",
   ...
   function detail(id){
        window.location = site_url+"d_pembelianb/view_detail/"+id;
    }
