    ...
    $(document).ready(function() {
       ...
       $("#batalBtn").click(function (){
            $.ajax({
                url : site_url+'d_penjualanpartai/batal/'+$("#no_penjualan").val(),
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
                   if(data.status){
                       window.location = site_url+"penjualanpartai";
                   }
                }
            });  
       });
       ...
       $( "#id_customer" ).autocomplete({
                    source: site_url+"pembeli/daftar_pembeli",
                    minLength: 2,
       ...
       $('#gudang').change(function (){
        ...
        userTable = $('#example').DataTable({ 
            ...
            "ajax": {
                "url": site_url+"d_penjualanpartai/view/"+$("#no_penjualan").val(),
                "type": "POST",
                data:{ajaxreq:true}
            },
            "columnDefs": [
        ...
        $('#qty').on('keyup', function(){
         ...
         $('#prosessBtn').on('click', function(){
             ...
             $.ajax({
                url : site_url+"penjualanpartai/detail/"+$("#pno_penjualan").val(),
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
                    if(data.id_customer != null){
                        $('#id_customer').val(data.id_customer+"- "+data.nama_toko);
                    }else{
                        $('#id_customer').val("");
                    }
        ...
        $('#yesBtn').on('click', function(){
            $.ajax({
                url : site_url+"d_penjualanpartai/delete/"+deletedId ,
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
    ...
    function addUser(fv){
         ...
         var url;
         if(action == "Add"){
             url = site_url+"d_penjualanpartai/add";
         }else{
             url = site_url+"d_penjualanpartai/update";
             action = "Add";
         }
    ...
    function addUser2(fv){
         ...
         var url = site_url+"penjualanpartai/update";
    ...
    function change(id){
        ...
        $('#username2').val(id);
        $.ajax({
                url : site_url+"d_penjualanpartai/detail/"+id ,
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
    ...
    function print_kw(id){
     ...
     function total_jual(id){
         $.ajax({
                url : site_url+"penjualanpartai/get_total_jual/"+id,
                type: "GET",
                dataType: "JSON",
          ...
          if(gudang != ""){
              ...
              $( "#id_barang" ).autocomplete({
                    ...
                    select: function( event, ui ) {
                        ...
                        $.ajax({
                        url : site_url+'barang/get_harga_grosir/'+res,
                        type: "GET",
                        dataType: "JSON",
                        success: function(data)
                        {
