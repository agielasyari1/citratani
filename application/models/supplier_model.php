...
class supplier_model extends CI_Model {
    ...
    var $table = 'supplier';
    var $column = array('id_supplier','nama_toko','nama','alamat', 'no_telp'); //set column field database for order and search
    ...
    function daftar_supplier($term) {
        ...
        if($query->result()){
            foreach ($query->result() as $supplier) {
                $list[] = $supplier->id_supplier."- ".$supplier->nama_toko;
            }
        } else{
     ...
     function add(){
        ...
        $inserted = $this->db->insert('supplier', array(
    ...
    function update(){
        ...
        $this->db->where('id_supplier', $this->input->post('username2'));
        $this->db->update('supplier', $ubah);
