<!-- main content start-->
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Pembeli</h3>
                                        <button type="button" id="addBtn" class="btn btn-primary btn-small"><i class="fa fa-plus"></i> Tambah Pembeli </button>
						<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
										<h4 class="modal-title" id="exampleModalLabel">Tambah Pembeli</h4>
									</div>
									<div class="modal-body">
										<form id="addUserForm" class="form-horizontal" data-toggle="validator"> 
                                                                                    ...
                                                                                    <div class="form-group"> 
                                                                                            <label for="no_telp" class="col-sm-2 control-label">Tipe.</label> 
                                                                                            <div class="col-sm-9"> 
                                                                                                <select type="text" class="form-control" id="tipe" name="tipe" placeholder="Tipe">
...
<script src="<?php echo base_url('assets/js/app/pembeli.js');?>"></script>