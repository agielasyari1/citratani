										...
										<form id="addUserForm2" class="form-horizontal" data-toggle="validator"> 
                                                                                    <div class="form-group"> 
                                                                                     ...
                                                                                     <div class="form-group"> 
                                                                                            ...
                                                                                            <div class="col-sm-3"> 
                                                                                                <input type="text" class="form-control" id="tanggal_permintaan" value="<?php echo date("Y-m-d")?>" name="tanggal_permintaan" placeholder="Tanggal Permintaan"> 
                                                                                            </div> 
...
<script src="<?php echo base_url('assets/js/app/d_pembeliana.js');?>"> </script>