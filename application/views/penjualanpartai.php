<!-- main content start-->
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Penjualan Partai</h3>
                                        <button type="button" id="addBtn" class="btn btn-primary btn-small"><i class="fa fa-plus"></i> Penjualan Baru </button>
...
<script src="<?php echo base_url('assets/js/app/penjualanpartai.js');?>"> </script>