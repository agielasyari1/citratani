<!-- main content start-->
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Satuan Barang</h3>
                                        <button type="button" id="addBtn" class="btn btn-primary btn-small"><i class="fa fa-plus"></i> Satuan Barang </button>
...
<script src="<?php echo base_url('assets/js/app/satuan.js');?>"></script>