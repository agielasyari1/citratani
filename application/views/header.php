...
.ui-autocomplete-loading { background:url("../../assets/images/loading.gif") no-repeat right center }
</style>
<script>
            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						...
						<li>
							<a href="#"><i class="fa fa-table nav_icon"></i>Master Data<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level collapse">
								<li>
                                                                    <a href="<?php echo site_url('supplier');?>">Supplier</a>
								</li>
								<li>
                                                                    <a href="<?php echo site_url('pembeli');?>">Pembeli</a>
								</li>
								<li>
									...
									<a href="<?php echo site_url('pengguna');?>">Pengguna</a>
                                                                ...
                                                                <li>
									<a href="<?php echo site_url('kategori');?>">Kategori Barang</a>
								</li>
                                                                <li>
									<a href="<?php echo site_url('satuan');?>">Satuan Barang</a>
								</li>
							</ul>
							<!-- /nav-second-level -->
						</li>
						<li class="">
							...
							<!-- /nav-second-level -->
                                                ...
                                                <li>
							<a href="#"><i class="fa fa-book nav_icon"></i>Laporan<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level collapse">
								<li>
									<a href="<?php echo site_url('laporan_jual');?>"> Penjualan</a>
								</li>
								<li>
									<a href="<?php echo site_url('laporan_beli');?>"> Pembelian</a>
								</li>
								<li>
									<a href="<?php echo site_url('laporan_tl');?>"> Transaksi Lain </a>
								</li>
								<li>
									<a href="<?php echo site_url('laporan_lr');?>"> Laba Rugi </a>
								</li>
							</ul>
							<!-- //nav-second-level -->
						</li>
                                                ...
                                                <li>
							<a href="<?php echo site_url('pengaturan');?>"><i class="fa fa-gears nav_icon"></i>Pengaturan</a>
						</li>
